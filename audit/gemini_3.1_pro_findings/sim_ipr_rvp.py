...
meta = CPHDMetadata(
    ...
    ref_ch_id="Ch1",
    image_area=None, extended_area=None, collection_start=None,
    radar_mode="SPOTLIGHT", classification="U",
    srp_ecf=srp_ecf,
...
plt.imshow(img_mag, extent=[-10, 10, -10, 10], cmap='gray', origin='lower')
plt.title("IPR with RVP Bug")
plt.savefig("/home/feildaw/diffpfa/audit/ipr_rvp_bug.png")
print("Saved /home/feildaw/diffpfa/audit/ipr_rvp_bug.png")
